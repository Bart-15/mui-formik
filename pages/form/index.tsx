...
const DemoForm = () => {
  return (
    <>
      ...
      <Container>
        <Typography variant="h3" textAlign="center" gutterBottom mt={10}>
          Formik
        </Typography>
        ...
        <Stack component={Paper} elevation={2}>
          <Formik
            ...
            validationSchema={FormDemoSchema}
              ...
              >
                <Form>
                  ...
                  <Stack mb={2}>
                    ...
                    {touched.investmentRisk && errors.investmentRisk ? (
                  ...
                  <Box mb={2} display="flex" flexDirection="column">
                    <Field
                      error={
                        touched.dependents && errors.dependents ? true : false
                      }
                      name="dependents"
                      as={Select}
                      size="small"
